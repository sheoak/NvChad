...
nnoremap <silent> <CR>f :<C-u>CocCommand eslint.executeAutofix<CR>
nnoremap <silent> <CR><space> :<C-u>CocCommand eslint.executeAutofix<CR>:<C-u>CocCommand prettier.formatFile<CR>
